...
public class CorsConfig {
    ...
    public CorsConfigurationSource corsConfiguration() {
        ...
        corsConfiguration.setAllowedOrigins(
                Arrays.asList("http://localhost:3000", "http://localhost:4173", "http://localhost:5173")); // Chuyển array sang List
       // Các method nào được kết nối
        ...
        UrlBasedCorsConfigurationSource source = new UrlBasedCorsConfigurationSource(); // Quản lý các cấu hình CORS cho từng URL
