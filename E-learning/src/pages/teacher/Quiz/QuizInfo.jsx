...
const QuizInfo = () => {
    ...
    const handleCreateQuiz = async () => {
        ...
        if (!quizName || !level.length || !school.length || !subject || !major || duration <= 0)
            return;
                ...
                <div className="col-span-12 md:col-span-5 bg-white rounded-lg shadow p-6">
                    ...
                    <div className="mb-5">
                        ...
                        <input
                            ...
                            className={`w-full p-2 rounded border ${isQuizNameError ? "border-red-300 bg-red-50" : "border-gray-300"
                                } focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none`}
                        />
                        {isQuizNameError && (
                            <div className="text-red-400 text-xs mt-1">Trường này là bắt buộc.</div>
                        )}
                    </div>
                    ...
                    <div className="flex gap-4 mb-5">
                        <div className="flex-1">
                            ...
                            <Select isMulti options={levelOptions} value={level} onChange={setLevel} />
                            {isLevelError && (
                                <div className="text-red-400 text-xs mt-1">Trường này là bắt buộc.</div>
                            )}
                        </div>
                        <div className="flex-1">
                            ...
                            <Select isMulti options={schoolOptions} value={school} onChange={setSchool} />
                            {isSchoolError && (
                                <div className="text-red-400 text-xs mt-1">Trường này là bắt buộc.</div>
                            )}
                        </div>
                    ...
                    <div className="flex gap-4 mb-5">
                        <div className="flex-1">
                            <label className={`block font-medium mb-1 ${isMajorError ? "text-red-400" : ""}`}>
                                Ngành học <span className="text-red-500">*</span>
                            </label>
                            <Select options={majorOptions} value={major} onChange={setMajor} isClearable />
                            {isMajorError && (
                                <div className="text-red-400 text-xs mt-1">Trường này là bắt buộc.</div>
                            )}
                        </div>
                        <div className="flex-1">
                            <label className={`block font-medium mb-1 ${isSubjectError ? "text-red-400" : ""}`}>
                                Môn học <span className="text-red-500">*</span>
                            </label>
                            <Select options={subjectOptions} value={subject} onChange={setSubject} isClearable />
                            {isSubjectError && (
                                <div className="text-red-400 text-xs mt-1">Trường này là bắt buộc.</div>
                            )}
                        </div>
